...
.pf-c-description-list {
  ...
  --pf-c-description-list--m-horizontal__term--width: 14ch;
  --pf-c-description-list--m-horizontal__description--width: minmax(10ch, auto);
  --pf-c-description-list--m-horizontal__group--GridTemplateColumns: var(--pf-c-description-list--m-horizontal__term--width) var(--pf-c-description-list--m-horizontal__description--width);
...
@media screen and (min-width: 768px) {
  .pf-c-drawer > .pf-c-drawer__main > .pf-c-drawer__content {
    order: 0; }
...
@media (min-width: 768px) {
  ...
  .pf-c-drawer.pf-m-static.pf-m-panel-left > .pf-c-drawer__main > .pf-c-drawer__panel {
    ...
    margin-left: 0;
    transform: translateX(0); }
    .pf-c-drawer.pf-m-static.pf-m-panel-left > .pf-c-drawer__main > .pf-c-drawer__panel::after {
      right: 0;
      left: auto; }
...
@media (min-width: 768px) {
  .pf-c-drawer.pf-m-panel-left.pf-m-inline > .pf-c-drawer__main > .pf-c-drawer__panel {
    margin-right: calc(var(--pf-c-drawer__panel--FlexBasis) * -1);
    margin-left: 0;
    box-shadow: none;
    transform: translateX(-100%); }
  .pf-c-drawer.pf-m-panel-left.pf-m-inline.pf-m-expanded > .pf-c-drawer__main > .pf-c-drawer__panel {
    margin-right: 0;
    transform: translateX(0); }
  .pf-c-drawer.pf-m-panel-left.pf-m-inline > .pf-c-drawer__main > .pf-c-drawer__panel > .pf-c-drawer__body > .pf-c-drawer__head .pf-c-drawer__close {
    display: unset;
    visibility: visible; } }
...
@media (min-width: 992px) {
  ...
  .pf-c-drawer.pf-m-static-on-lg.pf-m-panel-left > .pf-c-drawer__main > .pf-c-drawer__panel {
    ...
    margin-left: 0;
    transform: translateX(0); }
    .pf-c-drawer.pf-m-static-on-lg.pf-m-panel-left > .pf-c-drawer__main > .pf-c-drawer__panel::after {
      right: 0;
      left: auto; }
...
@media (min-width: 992px) {
  .pf-c-drawer.pf-m-panel-left.pf-m-inline-on-lg > .pf-c-drawer__main > .pf-c-drawer__panel {
    margin-right: calc(var(--pf-c-drawer__panel--FlexBasis) * -1);
    margin-left: 0;
    box-shadow: none;
    transform: translateX(-100%); }
  .pf-c-drawer.pf-m-panel-left.pf-m-inline-on-lg.pf-m-expanded > .pf-c-drawer__main > .pf-c-drawer__panel {
    margin-right: 0;
    transform: translateX(0); }
  .pf-c-drawer.pf-m-panel-left.pf-m-inline-on-lg > .pf-c-drawer__main > .pf-c-drawer__panel > .pf-c-drawer__body > .pf-c-drawer__head .pf-c-drawer__close {
    display: unset;
    visibility: visible; } }
...
@media (min-width: 1200px) {
  ...
  .pf-c-drawer.pf-m-static-on-xl.pf-m-panel-left > .pf-c-drawer__main > .pf-c-drawer__panel {
    ...
    margin-left: 0;
    transform: translateX(0); }
    .pf-c-drawer.pf-m-static-on-xl.pf-m-panel-left > .pf-c-drawer__main > .pf-c-drawer__panel::after {
      right: 0;
      left: auto; }
...
@media (min-width: 1200px) {
  .pf-c-drawer.pf-m-panel-left.pf-m-inline-on-xl > .pf-c-drawer__main > .pf-c-drawer__panel {
    margin-right: calc(var(--pf-c-drawer__panel--FlexBasis) * -1);
    margin-left: 0;
    box-shadow: none;
    transform: translateX(-100%); }
  .pf-c-drawer.pf-m-panel-left.pf-m-inline-on-xl.pf-m-expanded > .pf-c-drawer__main > .pf-c-drawer__panel {
    margin-right: 0;
    transform: translateX(0); }
  .pf-c-drawer.pf-m-panel-left.pf-m-inline-on-xl > .pf-c-drawer__main > .pf-c-drawer__panel > .pf-c-drawer__body > .pf-c-drawer__head .pf-c-drawer__close {
    display: unset;
    visibility: visible; } }
...
@media (min-width: 1450px) {
  ...
  .pf-c-drawer.pf-m-static-on-2xl.pf-m-panel-left > .pf-c-drawer__main > .pf-c-drawer__panel {
    ...
    margin-left: 0;
    transform: translateX(0); }
    .pf-c-drawer.pf-m-static-on-2xl.pf-m-panel-left > .pf-c-drawer__main > .pf-c-drawer__panel::after {
      right: 0;
      left: auto; }
...
@media (min-width: 1450px) {
  .pf-c-drawer.pf-m-panel-left.pf-m-inline-on-2xl > .pf-c-drawer__main > .pf-c-drawer__panel {
    margin-right: calc(var(--pf-c-drawer__panel--FlexBasis) * -1);
    margin-left: 0;
    box-shadow: none;
    transform: translateX(-100%); }
  .pf-c-drawer.pf-m-panel-left.pf-m-inline-on-2xl.pf-m-expanded > .pf-c-drawer__main > .pf-c-drawer__panel {
    margin-right: 0;
    transform: translateX(0); }
  .pf-c-drawer.pf-m-panel-left.pf-m-inline-on-2xl > .pf-c-drawer__main > .pf-c-drawer__panel > .pf-c-drawer__body > .pf-c-drawer__head .pf-c-drawer__close {
    display: unset;
    visibility: visible; } }
...
.pf-c-table__expandable-row {
  ...
  .pf-c-table__expandable-row td.pf-m-no-padding, .pf-c-table__expandable-row th.pf-m-no-padding {
    padding: 0 0 0 var(--pf-c-table__expandable-row--after--border-width--base); }
    .pf-c-table__expandable-row td.pf-m-no-padding .pf-c-table__expandable-row-content, .pf-c-table__expandable-row th.pf-m-no-padding .pf-c-table__expandable-row-content {
      padding: 0; }
...
.pf-c-toggle-group {
  --pf-c-toggle-group__button--PaddingTop: var(--pf-global--spacer--sm);
  --pf-c-toggle-group__button--PaddingRight: var(--pf-global--spacer--md);
  --pf-c-toggle-group__button--PaddingBottom: var(--pf-global--spacer--sm);
