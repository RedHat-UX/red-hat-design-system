...
const dropdownMenuItemStyles = css `a{padding:var(--rh-space-md) 0 var(--rh-space-md) var(--rh-space-lg);font-size:var(--rh-font-size-body-text-md)}`;
