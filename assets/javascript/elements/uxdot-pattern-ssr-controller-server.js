...
export class UxdotPatternSSRControllerServer extends RHDSSSRController {
    ...
    async ssrSetup() {
        ...
        const allContent = await __classPrivateFieldGet(this, _UxdotPatternSSRControllerServer_instances, "m", _UxdotPatternSSRControllerServer_getPatternContent).call(this);
        ...
        const cssContent = await __classPrivateFieldGet(this, _UxdotPatternSSRControllerServer_instances, "m", _UxdotPatternSSRControllerServer_extractInlineContent).call(this, 'css', partial);
        const jsContent = await __classPrivateFieldGet(this, _UxdotPatternSSRControllerServer_instances, "m", _UxdotPatternSSRControllerServer_extractInlineContent).call(this, 'js', partial);
...
_UxdotPatternSSRControllerServer_instances = new WeakSet(), _UxdotPatternSSRControllerServer_extractInlineContent = async function _UxdotPatternSSRControllerServer_extractInlineContent(kind, partial) {
    ...
    return content.trim();
}, _UxdotPatternSSRControllerServer_getPatternContent = async function _UxdotPatternSSRControllerServer_getPatternContent() {
    const { src } = this.host;
    if (!src) {
        return '';
    }
