...
function i12({ PfeIcon: n24, config: e23 = window.PfeConfig }) {
...
var init_builtin_icon_sets = __esm({
  "node_modules/@patternfly/pfe-icon/builtin-icon-sets.js"() {
    ...
    a7 = /* @__PURE__ */ __name((n24, e23, t15) => {
...
var init_pfe_icon = __esm({
  "node_modules/@patternfly/pfe-icon/pfe-icon.js"() {
    ...
    r10 = /* @__PURE__ */ __name((n24, l22, e23, i24) => {
      ...
      return i24 && t15 && m4(l22, e23, t15), t15;
    }, "r");
    ...
    o9 = /* @__PURE__ */ __name(class extends s4 {
      ...
      connectedCallback() {
        super.connectedCallback(), d4.add(this);
      }
      render() {
      ...
      disconnectedCallback() {
        super.disconnectedCallback(), d4.delete(this);
      }
      _iconLoad() {
...
var o10, i13, a8, l10, s6;
var init_static = __esm({
  "node_modules/lit-html/static.js"() {
    init_lit_html();
    o10 = /* @__PURE__ */ __name((t15) => ({ _$litStatic$: t15 }), "o");
    i13 = /* @__PURE__ */ new Map();
    a8 = /* @__PURE__ */ __name((t15) => (e23, ...o24) => {
      var r20;
      ...
      if ($4 === a21 && n24.push(e23[a21]), v12) {
        ...
        void 0 === (e23 = i13.get(t16)) && (n24.raw = n24, i13.set(t16, e23 = n24)), o24 = u18;
      }
      return t15(e23, ...o24);
    }, "a");
    l10 = a8($);
...
var init_slot_controller = __esm({
  "node_modules/@patternfly/pfe-core/controllers/slot-controller.js"() {
    ...
    a9 = /* @__PURE__ */ __name((i24, t15, e23, o24) => {
      for (var s23 = o24 > 1 ? void 0 : o24 ? m5(t15, e23) : t15, n24 = i24.length - 1, r20; n24 >= 0; n24--)
        (r20 = i24[n24]) && (s23 = (o24 ? r20(t15, e23, s23) : r20(s23)) || s23);
      return o24 && s23 && c7(t15, e23, s23), s23;
    }, "a");
    __name(u3, "u");
    p5 = /* @__PURE__ */ __name((i24) => (t15) => i24 === l11.anonymous ? !t15.hasAttribute("slot") : t15.getAttribute("slot") === i24, "p");
    d5 = /* @__PURE__ */ __name(class {
      constructor(t15, ...e23) {
        this.host = t15;
      ...
      getSlotted(...t15) {
        return t15.length ? t15.flatMap((e23) => this.nodes.get(e23)?.elements ?? []) : this.nodes.get(d5.anonymous)?.elements ?? [];
      }
      onSlotChange(t15) {
      ...
      initSlot(t15) {
        let e23 = t15 || d5.anonymous, o24 = this.nodes.get(e23)?.slot?.assignedElements?.() ?? this.getChildrenForSlot(e23), s23 = t15 ? `slot[name="${t15}"]` : "slot:not([name])", n24 = this.host.shadowRoot?.querySelector?.(s23) ?? null, r20 = !!o24.length;
...
var init_pfe_accordion_header = __esm({
  "node_modules/@patternfly/pfe-accordion/pfe-accordion-header.js"() {
    ...
    o11.version = "2.0.0-next.4", o11.styles = [f4], o11.shadowRootOptions = { ...s4.shadowRootOptions, delegatesFocus: true }, t6([e4({ attribute: "aria-controls", reflect: true })], o11.prototype, "ariaControls", 2), t6([e4({ type: String, reflect: true })], o11.prototype, "disclosure", 2), t6([p3, e4({ type: Boolean, reflect: true })], o11.prototype, "expanded", 2), t6([e4({ reflect: true, attribute: "heading-text" })], o11.prototype, "headingText", 2), t6([e4({ reflect: true, attribute: "heading-tag" })], o11.prototype, "headingTag", 2), t6([x2(), e4({ reflect: true })], o11.prototype, "on", 2), t6([i4(".pf-c-accordion__toggle")], o11.prototype, "button", 2), t6([c5()], o11.prototype, "_init", 1), t6([o6], o11.prototype, "_getHeaderElement", 1), t6([o6], o11.prototype, "_clickHandler", 1), o11 = t6([n5("pfe-accordion-header"), d3()], o11);
  }
});
...
var init_pfe_accordion_panel = __esm({
  "node_modules/@patternfly/pfe-accordion/pfe-accordion-panel.js"() {
    ...
    o12.version = "2.0.0-next.4", o12.styles = [...i14.styles, f6], a10([e4({ type: String, reflect: true })], o12.prototype, "disclosure", 2), a10([e4({ type: Boolean, reflect: true })], o12.prototype, "expanded", 2), a10([e4({ attribute: "aria-labelledby", reflect: true })], o12.prototype, "ariaLabelledby", 2), a10([x2(), e4({ reflect: true })], o12.prototype, "on", 2), o12 = a10([n5("pfe-accordion-panel"), d3()], o12);
  }
});
...
init_lit();
var styles3 = r`:host(:is([on=dark])) { --context: dark; }
...
var ColorContextProvider = class extends ColorContextController {
  ...
  hostConnected() {
    this.host.addEventListener("context-request", (e23) => __classPrivateFieldGet(this, _ColorContextProvider_instances, "m", _ColorContextProvider_onChildContextEvent).call(this, e23));
...
var ColorContextConsumer = class extends ColorContextController {
  ...
  hostConnected() {
    const event = new ContextEvent(this.context, (e23) => this.contextCallback(e23), true);
  ...
  render() {
    ...
    return $`
      <span id="container" part="container" class="${o8({ rtl })}">
        <slot @slotchange=${this.firstUpdated}></slot>${!__classPrivateFieldGet(this, _RhCta_instances, "a", _RhCta_isDefault_get) && !this.icon ? "" : this.icon ? $`
        <pfe-icon icon=${this.icon} size="sm"></pfe-icon>` : $`&nbsp;<svg xmlns="http://www.w3.org/2000/svg"
...
init_lit();
var styles8 = r`/* TODO: RHDS tokens */
:host {
...
var RhSecondaryNavMenu = /* @__PURE__ */ __name(class RhSecondaryNavMenu2 extends s4 {
  ...
  render() {
    ...
    return $`
      <div id="container" class="${o8(classes)}">${this.layout === "full-width" ? $`
...
var RhStat = /* @__PURE__ */ __name(class RhStat2 extends s4 {
  ...
  render() {
    ...
    return $`
          <slot class="${o8({ hasIcon: hasSlottedIcon || this.icon.length > 0 })}" name="icon">
            ${this.icon.length > 0 ? $`
...
var a13 = /* @__PURE__ */ __name(class extends s4 {
  ...
  render() {
    let t15 = this.data ?? [];
    return $`<div class="suggestions-aria-help sr-only" role="status" aria-hidden="false" aria-live="polite">${this.ariaAnnounceText}</div><div class="droplist"><ul id="droplist-items" part="listbox" role="listbox" @click="${this._optionSelected}" @keyup="${this._onKeyup}" tabindex="-1">${c10(t15, (i24) => i24, (i24, r20) => $`<li id="option-${r20}" part="option item-index-${r20}" class="${o8({ active: r20 === this.activeIndex })}" aria-selected="${String(r20 === this.activeIndex)}" role="option" tabindex="-1" value="${i24}">${i24}</li>`)}</ul></div>`;
  }
  _onKeyup(t15) {
    switch (t15.key) {
      case "Enter":
...
var e12 = /* @__PURE__ */ __name(class extends s4 {
  ...
  render() {
    ...
    return $`<section id="container" class="pfe-band__container ${o8({ "has-header": s23, "has-body": t15, "has-aside": o24, "has-footer": h21 })}" part="base">${b12 ? c20 : ""} ${u18} ${_7 ? c20 : ""}</section>`;
  }
...
var c12 = /* @__PURE__ */ __name(class extends s4 {
  ...
  render() {
    ...
    return $`<span id="container" class="${o8({ hasIcon: e23 })}"><span part="icon"><slot name="icon">${this.renderDefaultIcon()}</slot></span><slot></slot></span>`;
  }
  firstUpdated() {
...
var e13 = /* @__PURE__ */ __name(class extends s4 {
  ...
  render() {
    ...
    return $`<div class="pfe-card__header ${o8(r20)}" part="header"><slot name="header"></slot><slot name="pfe-card--header"></slot></div><div class="pfe-card__body ${o8(r20)}" part="body"><slot></slot></div><div class="pfe-card__footer ${o8(r20)}" part="footer"><slot name="footer"></slot><slot name="pfe-card--footer"></slot></div>`;
  }
...
var e16 = /* @__PURE__ */ __name(class extends s4 {
  ...
  render() {
    ...
    return $`${this.size ? "" : $`<div id="healthIndex">${i24.toUpperCase()}</div>`}<div class="box-container" part="container">${this.size === "mini" ? $`<div class="box ${o8({ [i24]: true, active: true })}" part="box"><div class="grade" id="healthIndex">${i24.toUpperCase()}</div></div>` : e16.grades.map((t15) => $`<div class="box ${o8({ active: i24 === t15, [t15]: true })}">${this.size === "lg" ? $`<div class="grade">${t15.toUpperCase()}</div><div class="bottom"></div>` : $`<div class="box ${o8({ active: i24 === t15, [t15]: true })}" part="box"></div>`}</div>`)}</div>`;
  }
  updated() {
