...
_UxdotCopyPermalink_internals = new WeakMap(), _UxdotCopyPermalink_instances = new WeakSet(), _UxdotCopyPermalink_copyLink = async function _UxdotCopyPermalink_copyLink() {
...
UxdotCopyPermalink.properties = {
    copyButtonLabel: { attribute: 'copy-button-label' },
    copiedText: { attribute: 'copied-text' }
};
