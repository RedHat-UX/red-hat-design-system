...
describe('<pf-label-group>', function () {
    ...
    describe('simply instantiating', function () {
        ...
        it('should upgrade', async function () {
            element = await createFixture(html `<pf-label-group></pf-label-group>`);
    ...
    describe('with 4 labels', function () {
      ...
      `);
        ...
        describe('clicking overflow label', function () {
            beforeEach(async function () {
                const overflow = element.shadowRoot?.querySelector('#overflow');
                overflow?.click();
...
//# sourceMappingURL=pf-label-group.spec.js.map