...
import { css } from "lit";
const styles = css `:host{display:block}:host([color-palette]){background-color:var(--rh-color-surface)}[part=container]{display:flex}[part=links]{display:contents}#link-container{display:flex;gap:0;position:relative;bottom:0;overflow-x:auto;scrollbar-width:none;max-width:100%;padding:0}::slotted(a){display:block!important;white-space:nowrap!important;padding:var(--rh-space-lg,16px) var(--rh-space-2xl,32px)!important;text-decoration:none!important;color:var(--rh-color-text-secondary)!important;position:relative!important}::slotted(a):after{content:""!important;position:absolute!important;inset:0!important;width:100%!important;border-block-end:var(--rh-border-width-lg,3px) solid #0000!important}::slotted(a:active),::slotted(a:hover),::slotted(a:is([active],[aria-current=page])){color:var(--rh-color-text-primary)!important}::slotted(a:focus-visible):after,::slotted(a:hover):after{border-block-end-color:var(--rh-color-border-subtle)!important}::slotted(a:active):after,::slotted(a:is([active],[aria-current=page])):after{border-block-end-color:var(--rh-color-accent-brand)!important}::slotted(a:focus-visible){outline:var(--rh-border-width-md,2px) solid var(--rh-color-border-interactive)!important;outline-offset:-2px!important;border-radius:10px!important}::slotted(a:visited){color:var(--rh-color-text-primary)!important}::slotted(rh-navigation-link){--rh-navigation-link-white-space:nowrap;--_navigation-link-display:flex;--_navigation-link-gap:var(--rh-space-xs,4px);--_navigation-link-align-items:center;--_navigation-link-inline-size:100%;--_navigation-link-padding:var(--rh-subnav-link-padding-block,var(--rh-space-lg,16px)) var(--rh-subnav-link-padding-inline,var(--rh-space-2xl,32px));--_navigation-link-font-size:var(--rh-font-size-body-text-md);--_navigation-link-text-decoration:none;--_navigation-link-text-decoration-style:none;--_navigation-link-text-decoration-line:none;--_navigation-link-color:var(--rh-color-text-primary);--_navigation-link-color-hover:var(--rh-color-text-primary);--_navigation-link-container-display:flex;--_navigation-link-container-align-items:center;--_navigation-link-container-position:relative;--_navigation-link-container-inline-size:100%;--_navigation-link-focus-outline-offset:-2px;position:relative;display:flex;flex-direction:column}::slotted(rh-navigation-link):after{display:block;content:"";z-index:1;width:100%;block-size:var(--rh-border-width-lg,3px);background-color:initial;pointer-events:none}::slotted(rh-navigation-link:hover):after{background-color:var(--rh-color-border-subtle)}::slotted(rh-navigation-link:active):after,::slotted(rh-navigation-link[current-page]):after{background-color:var(--rh-color-brand-red)}button{position:relative;padding:var(--rh-subnav-scroll-buttons-padding,0 var(--rh-space-lg,16px));margin:0;background-color:initial;border:none;color:var(--rh-color-text-secondary)}button:disabled{pointer-events:none;color:var(--rh-color-border-subtle)}button:hover{color:var(--rh-color-text-primary)}button:before{position:absolute;inset:0;content:"";border-block-end:var(--rh-border-width-lg,3px) solid #0000}:is(button:before):hover{border-block-end-color:var(--rh-color-border-subtle)}#previous{border-inline-end:var(--rh-border-width-sm,1px) solid var(--rh-color-border-subtle)}#next{border-inline-start:var(--rh-border-width-sm,1px) solid var(--rh-color-border-subtle)}#next,#previous{border-block-end:var(--rh-subnav-scroll-buttons-border-block-end,var(--rh-border-width-sm,1px) solid var(--rh-color-border-subtle))}:is(#next,#previous) rh-icon{pointer-events:none}:is(:is(#next,#previous) rh-icon):dir(rtl){rotate:180deg}`;
/**
    ...
    render() {
      ...
      <nav part="container"
        ...
        <div id="link-container" role="${ifDefined(this.hasNavigationLinks ? 'list' : undefined)}">
          ...
          -->
          <div part="links">
            <slot @slotchange="${__classPrivateFieldGet(this, _RhSubnav_instances, "m", _RhSubnav_onSlotchange)}"></slot>
          </div>
        </div>
        ${!__classPrivateFieldGet(this, _RhSubnav_overflow, "f").showScrollButtons ? '' : html `
          <button id="next"
