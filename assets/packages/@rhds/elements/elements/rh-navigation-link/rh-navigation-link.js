...
import { css } from "lit";
const styles = css `:host{display:contents}#container{display:var(--_navigation-link-container-display,block);inline-size:var(--_navigation-link-container-inline-size,fit-content);block-size:var(--_navigation-link-container-block-size,auto);padding:var(--_navigation-link-container-padding,initial);align-items:var(--_navigation-link-container-align-items,initial);position:var(--_navigation-link-container-position,initial)}::slotted(a),a{position:relative;display:var(--_navigation-link-display,inline);color:var(--_navigation-link-color,var(--rh-color-text-primary))!important;font-size:var(--rh-navigation-link-font-size,var(--_navigation-link-font-size,1rem))!important;font-weight:var(--_navigation-link-font-weight,initial)!important;block-size:var(--_navigation-link-block-size,auto);inline-size:var(--_navigation-link-inline-size,auto);align-items:var(--_navigation-link-align-items,initial);align-content:var(--_navigation-link-align-content,initial);padding:var(--_navigation-link-padding,0);text-decoration:var(--_navigation-link-text-decoration,none)!important;gap:var(--_navigation-link-gap,initial);background-color:var(--rh-navigation-link-background-color,var(--_navigation-link-background-color,#0000));white-space:var(--rh-navigation-link-white-space,initial);border-radius:var(--rh-navigation-link-border-radius,0)}::slotted(a):before,a:before{content:"";position:absolute;inset:0;inset-inline-start:var(--rh-navigation-link-inset-inline-start,0);width:var(--rh-navigation-link-border-inline-start-width,var(--_navigation-link-before-border-inline-start-width));height:100%;background-color:var(--_navigation-link-before-border-inline-start-color,#0000);border-radius:var(--rh-navigation-link-indicator-border-radius,0)}::slotted(:is(a:hover,a:hover:focus-visible,:focus-visible,:active)),a:is(:hover,:hover:focus-visible,:focus-visible,:active){--_navigation-link-background-color:var(--rh-navigation-link-hover-background-color,var(--_navigation-link-hover-background-color,light-dark(#0000,#0000)))!important;--_navigation-link-color:var(--_navigation-link-color-hover,var(--rh-color-interactive-primary-hover))!important;text-underline-offset:var(--_navigation-link-text-underline-offset,4px)!important;text-decoration-color:var(--_navigation-link-text-decoration-color,light-dark(var(--rh-color-gray-50,#707070),var(--rh-color-gray-40,#a3a3a3))
    )!important;text-decoration-line:var(--_navigation-link-text-decoration-line,underline)!important;text-decoration-style:var(--_navigation-link-text-decoration-style,dashed)!important;text-decoration-skip-ink:auto!important}::slotted(a:is(:focus-visible,:hover:focus-visible)),a:is(:focus-visible,:hover:focus-visible){outline-offset:var(--_navigation-link-focus-outline-offset,0);outline:var(--rh-color-interactive-primary-default) solid var(--rh-border-width-md,2px);border-radius:var(--rh-navigation-link-border-radius,var(--rh-border-radius-default,3px))}`;
/**
