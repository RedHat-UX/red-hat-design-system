...
_RhAccordion_expandedIndex = new WeakMap(), _RhAccordion_headerIndex = new WeakMap(), _RhAccordion_initialized = new WeakMap(), _RhAccordion_logger = new WeakMap(), _RhAccordion_mo = new WeakMap(), _RhAccordion_instances = new WeakSet(), _RhAccordion_init = 
/**
...
async function _RhAccordion_init() {
    ...
    if (__classPrivateFieldGet(this, _RhAccordion_instances, "a", _RhAccordion_activeHeader_get)) {
        __classPrivateFieldGet(this, _RhAccordion_headerIndex, "f").updateActiveItem(__classPrivateFieldGet(this, _RhAccordion_instances, "a", _RhAccordion_activeHeader_get));
    }
