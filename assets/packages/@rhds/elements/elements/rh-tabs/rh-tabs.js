var _RhTabs_instances, _RhTabs_ctx_get, _RhTabs_overflow, _RhTabs_tabs, _RhTabs_tabindex, _RhTabs_firstTab_get, _RhTabs_lastTab_get, _RhTabs_onSlotchange, _RhTabs_onExpand, _RhTabs_updateActive;
        ...
        <div part="container" class="${classMap({ overflow: __classPrivateFieldGet(this, _RhTabs_overflow, "f").showScrollButtons })}">
          <div part="tabs-container">${!__classPrivateFieldGet(this, _RhTabs_overflow, "f").showScrollButtons ? '' : html `
            <button id="previousTab" tabindex="-1"
                    ...
                    @click="${() => __classPrivateFieldGet(this, _RhTabs_overflow, "f").scrollLeft()}">
            ...
            <button id="nextTab"
                    ...
                    @click="${() => __classPrivateFieldGet(this, _RhTabs_overflow, "f").scrollRight()}">
