var _RhTab_instances, _RhTab_slots, _RhTab_internals, _RhTab_onClick, _RhTab_onFocus, _RhTab_onKeydown, _RhTab_activate;
...
let RhTab = class RhTab extends LitElement {
    constructor() {
        ...
        this.firstTab = null;
        this.lastTab = null;
        _RhTab_slots.set(this, new SlotController(this, 'icon', null));
    ...
    render() {
      ...
      <div id="button"
        ...
        <slot name="icon"
              part="icon"
              ?hidden="${__classPrivateFieldGet(this, _RhTab_slots, "f").hasSlotted('icon')}"
