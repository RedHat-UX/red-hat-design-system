...
], RhTab.prototype, "icon", void 0);
__decorate([
    property({ attribute: 'icon-set' })
], RhTab.prototype, "iconSet", void 0);
__decorate([
...
__decorate([
    observes('icon')
], RhTab.prototype, "iconChanged", null);
__decorate([
    observes('active')
