...
import { css } from "lit";
const styles = css `:host{display:block}details summary{display:flex;flex-direction:row;justify-content:space-between;background:var(--rh-navigation-vertical-list-summary-background-color,#0000);padding:var(--rh-space-md,8px) var(--rh-space-lg,16px);list-style:none;cursor:pointer;position:relative;place-items:center;border-radius:var(--rh-navigation-vertical-list-summary-border-radius,0);gap:var(--rh-space-lg,16px)}:is(details summary)::-webkit-details-marker,:is(details summary)::marker{display:none}:is(details summary):is(:hover,:focus){background:var(--rh-navigation-vertical-list-summary-hover-background-color,light-dark(var(--rh-color-surface-lighter,#f2f2f2),var(--rh-color-surface-dark,#383838))
        )}:is(details summary) ::slotted([slot=summary]){font-family:var(--rh-font-family-body-text);font-size:var(--rh-font-size-body-text-md,1rem)!important;font-weight:var(--rh-font-weight-body-text-regular,400)}:is(details summary) rh-icon{transition:.2s;will-change:rotate;position:relative}details[open] rh-icon{transform:rotate(-180deg)}details #subtree{display:flex;flex-direction:column;gap:var(--rh-space-xs,4px);margin-inline:var(--rh-navigation-vertical-list-nested-margin-inline,var(--rh-space-lg,16px) 0);margin-block:var(--rh-navigation-vertical-list-nested-margin-block,var(--rh-space-xs,4px) var(--_subtree-margin-block-end,var(--rh-space-md,8px))
      )}::slotted(rh-navigation-vertical-list){font-size:var(--rh-font-size-body-text-sm,.875rem);--_subtree-margin-block-end:0}::slotted(rh-navigation-link){--_navigation-link-display:flex;--_navigation-link-align-items:center;--_navigation-link-inline-size:100%;--_navigation-link-padding:var(--rh-space-md,8px) var(--rh-space-lg,16px);--_navigation-link-font-size:var(--rh-font-size-body-text-sm,0.875rem);--_navigation-link-text-decoration:none;--_navigation-link-text-decoration-style:none;--_navigation-link-text-decoration-line:none;--_navigation-link-color:var(--rh-color-text-primary);--_navigation-link-color-hover:var(--rh-color-text-primary);--_navigation-link-hover-background-color:light-dark(var(--rh-color-surface-lighter,#f2f2f2),var(--rh-color-surface-dark,#383838));--_navigation-link-container-display:flex;--_navigation-link-container-align-items:center;--_navigation-link-container-position:relative;--_navigation-link-container-inline-size:100%}::slotted(rh-navigation-link:hover){--_navigation-link-before-border-inline-start-width:var(--rh-border-width-md,2px);--_navigation-link-before-border-inline-start-color:var(--rh-color-border-subtle)}::slotted(rh-navigation-link:active){--_navigation-link-before-border-inline-start-width:var(--rh-border-width-md,2px);--_navigation-link-before-border-inline-start-color:var(--rh-color-brand-red)}::slotted(rh-navigation-link[current-page]){--_navigation-link-background-color:light-dark(var(--rh-color-surface-lighter,#f2f2f2),var(--rh-color-surface-dark,#383838));--_navigation-link-before-border-inline-start-width:var(--rh-border-width-md,2px);--_navigation-link-before-border-inline-start-color:var(--rh-color-brand-red)}.highlight ::slotted(rh-navigation-link:first-child){--_navigation-link-font-weight:var(--rh-font-weight-body-text-medium,500)}`;
/**
