...
import { LitElement, html, render, svg } from 'lit';
...
let RhAlert = class RhAlert extends LitElement {
    ...
    render() {
        ...
        const hasBody = __classPrivateFieldGet(this, _RhAlert_slots, "f").hasSlotted(SlotController.default);
        return html `
