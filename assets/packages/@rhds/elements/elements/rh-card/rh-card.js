var _RhCard_instances, _RhCard_slots, _RhCard_isPromo, _RhCard_isStandardPromo, _RhCard_computedPalette_get;
...
_RhCard_computedPalette_get = function _RhCard_computedPalette_get() {
    if (__classPrivateFieldGet(this, _RhCard_isStandardPromo, "f")) {
        return `${`${this.colorPalette ?? 'lightest'}`.replace(PALETTE_RE, '')}er`;
    }
    else if (__classPrivateFieldGet(this, _RhCard_isPromo, "f")) {
        return `${`${this.colorPalette ?? 'lightest'}`.replace(PALETTE_RE, '')}est`;
    }
    else {
