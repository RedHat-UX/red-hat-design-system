...
let RhButton = class RhButton extends LitElement {
    ...
    render() {
      ...
      <button aria-label="${ifDefined(label)}"
        ...
        <span aria-hidden=${String(!!label)}><!-- summary: button text label
               description: |
