...
import { css } from "lit";
const styles = css `:host{--_border:var(--rh-border-width-sm,1px) solid light-dark(var(--rh-color-gray-30,#c7c7c7),var(--rh-color-gray-50,#707070));--_color:var(--rh-color-text-primary);position:relative;display:inline-block}#menu-list{position:absolute;padding:var(--rh-menu-dropdown-panel-padding,var(--rh-space-md,8px) 0);left:0;top:0;z-index:1000;min-inline-size:18.5rem;max-inline-size:100%;border-radius:var(--rh-menu-dropdown-panel-border-radius,var(--rh-border-radius-default,3px));border:var(--rh-menu-dropdown-panel-border,var(--_border));background:var(--rh-menu-dropdown-panel-background,light-dark(var(--rh-color-surface-lightest,#fff),var(--rh-color-surface-darkest,#151515)));box-shadow:var(--rh-menu-dropdown-panel-box-shadow,var(--rh-box-shadow-md,0 4px 6px 1px #15151540));transition:opacity .3s cubic-bezier(.54,1.5,.38,1.11) 0s;translate:var(--_floating-content-translate)}.visible{display:block}::slotted([slot=toggle-label]){color:var(--_color);font-family:var(--rh-font-family-body-text,RedHatText,"Red Hat Text",Helvetica,Arial,sans-serif);font-size:var(--rh-font-size-body-text-md,1rem)!important;font-style:normal;font-weight:var(--rh-font-weight-body-text-regular,400);line-height:var(--rh-line-height-code,1.5)}#menu-toggle{--_interactive-border-color:light-dark(var(--rh-color-accent-base-on-light,#06c),var(--rh-color-accent-base-on-dark,#92c5f9));color:var(--_color);font-family:var(--rh-font-family-body-text,RedHatText,"Red Hat Text",Helvetica,Arial,sans-serif);font-size:var(--rh-font-size-body-text-md,1rem);font-style:normal;font-weight:var(--rh-font-weight-body-text-regular,400);line-height:var(--rh-line-height-code,1.5);inline-size:100%;padding:var(--rh-space-sm,6px) var(--rh-space-lg,16px);display:flex;align-items:center;justify-content:space-between;box-sizing:border-box;border-radius:var(--rh-border-radius-default,3px);background:var(--rh-menu-dropdown-toggle-background,light-dark(var(--rh-color-surface-lightest,#fff),var(--rh-color-surface-darkest,#151515)));border:none}#menu-toggle .action-icon rh-icon{--rh-icon-size:var(--rh-menu-dropdown-caret-size,10px);padding-inline-start:var(--rh-space-md,8px)}#menu-toggle .info-section{display:flex;align-items:center;justify-content:flex-start}#menu-toggle.boxed{box-shadow:inset 0 0 0 1px var(--rh-menu-dropdown-toggle-border-color,light-dark(var(--rh-color-gray-30,#c7c7c7),var(--rh-color-gray-50,#707070)))}#menu-toggle.boxed:not(.open):hover{box-shadow:inset 0 0 0 1px var(--rh-menu-dropdown-hover-border-color,var(--_interactive-border-color))}#menu-toggle.boxed:not(.open):active{box-shadow:inset 0 0 0 var(--rh-length-3xs,2px) var(--rh-menu-dropdown-active-border-color,var(--_interactive-border-color))}#menu-toggle.boxed:not(.open):focus{outline:var(--rh-length-3xs,2px) solid var(--rh-menu-dropdown-focus-border-color,var(--_interactive-border-color));outline-offset:var(--rh-length-3xs,2px)}#menu-toggle.boxed.open{box-shadow:inset 0 0 0 var(--rh-length-3xs,2px) var(--rh-menu-dropdown-open-border-color,var(--_interactive-border-color))}#menu-toggle.boxed.open:focus{outline:var(--rh-length-3xs,2px) solid var(--rh-menu-dropdown-focus-border-color,var(--_interactive-border-color));outline-offset:var(--rh-length-3xs,2px)}#menu-toggle.boxed.disabled{box-shadow:var(--rh-menu-dropdown-disabled-box-shadow,inset 0 0 0 1px var(--rh-menu-dropdown-toggle-border-color,light-dark(var(--rh-color-gray-30,#c7c7c7),var(--rh-color-gray-50,#707070))))}#menu-toggle.compact{padding:var(--rh-space-md,8px);min-block-size:var(--rh-menu-dropdown-compact-size,auto);min-inline-size:var(--rh-menu-dropdown-compact-size,auto);justify-content:var(--rh-menu-dropdown-compact-justify,space-between)}#menu-toggle.compact.open:not(.boxed),#menu-toggle.compact:not(.boxed):active,#menu-toggle.compact:not(.boxed):focus,#menu-toggle.compact:not(.boxed):hover{background-color:light-dark(var(--rh-color-surface-lighter,#f2f2f2),var(--rh-color-surface-darker,#1f1f1f))}#menu-toggle.compact:not(.boxed):focus{outline:var(--rh-length-3xs,2px) solid var(--_interactive-border-color);outline-offset:var(--rh-length-3xs,2px)}#menu-toggle.compact:not(.boxed):active{box-shadow:inset 0 0 0 var(--rh-length-3xs,2px) var(--_interactive-border-color)}#menu-toggle.compact.disabled{background:var(--rh-menu-dropdown-compact-disabled-background,light-dark(var(--rh-color-gray-30,#c7c7c7),var(--rh-color-gray-40,#a3a3a3)))}#menu-toggle.compact.disabled .action-icon rh-icon{color:var(--rh-menu-dropdown-compact-disabled-icon-color,light-dark(var(--rh-color-gray-50,#707070),var(--rh-color-gray-60,#4d4d4d)))}#menu-toggle.disabled{pointer-events:none;cursor:not-allowed;background:light-dark(var(--rh-color-gray-30,#c7c7c7),var(--rh-color-gray-40,#a3a3a3))}#menu-toggle.disabled:active,#menu-toggle.disabled:focus,#menu-toggle.disabled:hover{box-shadow:none}#menu-dropdown-container{inline-size:100%;position:relative}::slotted(hr){border:0;border-top:var(--_border);inline-size:100%}::slotted(rh-icon){margin-inline-end:var(--rh-space-md,8px)}rh-menu::part(menu){inline-size:100%}:host([aria-disabled=true]){pointer-events:none;cursor:not-allowed}:host([disabled]) .action-icon rh-icon,:host([disabled]) ::slotted([slot=toggle-label]){color:light-dark(var(--rh-color-gray-50,#707070),var(--rh-color-gray-60,#4d4d4d))}`;
