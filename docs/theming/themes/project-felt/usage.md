...
The Project Felt preview theme CSS is compatible with [Red Hat Design System version 4.2.0](https://deploy-preview-2985--red-hat-design-system.netlify.app/release-notes/#version-4.2) and above.
