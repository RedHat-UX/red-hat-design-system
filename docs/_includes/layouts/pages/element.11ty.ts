            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                   ${slot.name === '' ? await this.#innerMD(`<strong>Note:</strong> [default] <a href="https://github.com/RedHat-UX/red-hat-design-system/wiki/Shadow-DOM-Style-Guide#slot-names">unnamed slots</a> do not have a slot="name" attribute. ${slot.description}`) : await this.#innerMD(slot.description)}
                  </td>
                </tr>`))).join('')}
              </tbody>
            </table>
