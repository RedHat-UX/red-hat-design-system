 ...
 *
 * By default it is black text on a black bacground
 *
 * @summary An alert to display information on a website.
 *
 *
 * @slot title - Provide a title for the alert message.
 * @slot description - Provide a description for the alert message
 * @slot action-group - Provide actions that the user can take for the alert
 ...
 */
@customElement('rh-alert') @pfelement()
export class RhAlert extends LitElement {
  ...
  render() {
    return html`
      <div class="rh-alert__container" role="alert" aria-hidden="false">
        <div class="rh-alert__left-column">
            <div class="rh-alert__icon">
                ${this.icon}
            </div>
        </div>
        <div class="rh-alert__middle-column">
            <div class="rh-alert__header">
                <div class="rh-alert__title">
                    <slot name="title"></slot>
                </div>
                <div class="rh-alert__header-actions">
                    <button id="close-button" class="rh-alert__close-button" type="button" aria-label="Close" confirm>
            ...
            <div class="rh-alert__description">
                <slot name="description"></slot>
            </div>
            <div class="rh-alert__action-group">
