...
describe('<rh-tile>', function() {
  ...
  describe('simply instantiating', function() {
    ...
    it('should upgrade', async function() {
      ...
      expect(element)
          ...
          .and.to.be.an.instanceOf(RhTile);
    });
  });
  ...
  describe('default tile', function() {
    ...
    beforeEach(async function() {
      element = await createFixture<RhTile>(html` <rh-tile>
  ...
  describe('checkable tile', function() {
    ...
    beforeEach(async function() {
      element = await createFixture<RhTile>(html` <rh-tile checkable>
        <img slot="image" src="${dataurl}" alt="296 X 50 placeholder" />
        <div slot="title">Title</div>
        <h2 slot="headline"><a href="#top">Link</a></h2>
        Lorem ipsum dolor sit amet, consectetur adipiscing elit.
