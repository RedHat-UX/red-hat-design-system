  ...
  render() {
    ...
    return html`
      <div id="container" class="${classMap({ mobile })}">${this.pattern ? html`
        ...
        <img part="img" role="presentation" src="${this.src}">` : html`
        <svg id="default" part="img" style="enable-background:new 0 0 36 36" role="presentation" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
          <path class="st1" d="M0 0h36v36H0z"/><path class="st3" d="M17.7 20.1c-3.5 0-6.4-2.9-6.4-6.4s2.9-6.4 6.4-6.4 6.4 2.9 6.4 6.4-2.8 6.4-6.4 6.4z"/>
          <path class="st2" d="M13.3 36v-6.7c-2 .4-2.9 1.4-3.1 3.5l-.1 3.2h3.2z"/>
          <path class="st4" d="m10.1 36 .1-3.2c.2-2.1 1.1-3.1 3.1-3.5V36h9.4v-6.7c2 .4 2.9 1.4 3.1 3.5l.1 3.2h4.7c-.4-3.9-1.3-9-2.9-11-1.1-1.4-2.3-2.2-3.5-2.6s-1.8-.6-6.3-.6-6.1.7-6.1.7c-1.2.4-2.4 1.2-3.4 2.6-1.7 1.9-2.6 7.1-3 10.9h4.7z"/>
          <path class="st2" d="m25.9 36-.1-3.2c-.2-2.1-1.1-3.1-3.1-3.5V36h3.2z"/>
        </svg>
        `}
