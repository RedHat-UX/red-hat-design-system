...
<uxdot-example width-adjustment="823px">
  <img src="{{ '../avatar-usage-sizes.png' | url }}" alt="Image of all avatar thumbnail sizes and their pixel values underneath">
</uxdot-example>
...
<uxdot-example width-adjustment="611px">
  <img src="{{ '../avatar-writing-content.png' | url }}" alt="Image of three job details text, ranging from short to long"> 
</uxdot-example>
...
<uxdot-example width-adjustment="625px">
  <img src="{{ '../avatar-usage-alignment.png' | url }}" alt="Image of two avatar groups; one is horizontally centered and the other is vertically centered">
</uxdot-example>
...
<uxdot-example width-adjustment="385px">
  <img src="{{ '../avatar-usage-stacking.png' | url }}" alt="Image of three avatar groups stacked vertically with 48 pixel of space in between">
</uxdot-example>
...
<uxdot-example variant="full" no-border alignment="left" width-adjustment="1000px">
  <img src="{{ '../avatar-breakpoints-large.png' | url }}" alt="Image of two avatar groups used on large breakpoints; one is aligned left and the other is aligned in the center">
</uxdot-example>

### Small breakpoints

<uxdot-example variant="full" no-border alignment="left" width-adjustment="576px">
  <img src="{{ '../avatar-breakpoints-small.png' | url }}" alt="Image of four avatar groups used on small breakpoints; two are aligned left and the other two are aligned in the center">
</uxdot-example>
...
<uxdot-example width-adjustment="498px">
  <img src="{{ '../avatar-line-breaks.png' | url }}" alt="Image of two avatar groups with specs on top; one has two lines and the other has five lines">
</uxdot-example>
...
<uxdot-example danger width-adjustment="293px">
  <img src="{{ '../avatar-best-practice-1.png' | url }}" alt="Image of a square avatar thumbnail which is incorrect usage">
</uxdot-example>
...
<uxdot-example danger width-adjustment="270px">
  <img src="{{ '../avatar-best-practice-2.png' | url }}" alt="Image of a light theme avatar thumbnail placed on a black background which is incorrect usage">
</uxdot-example>
...
<uxdot-example danger width-adjustment="136px">
  <img src="{{ '../avatar-best-practice-3.png' | url }}" alt="Image of an icon and avatar thumbnail right next to each other which is incorrect usage">
</uxdot-example>
