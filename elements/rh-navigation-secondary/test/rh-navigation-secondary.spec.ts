...
import { html, expect, assert, fixture, aTimeout, oneEvent } from '@open-wc/testing';
...
describe('<rh-navigation-secondary>', async function() {
  beforeEach(async function() {
    element = await fixture<RhNavigationSecondary>(html`
  ...
  it('should remove role="navigation" after upgrade', async function() {
    expect(element).to.not.have.attribute('role');
  });

  it('should by default set color-palette="lighter"', async function() {
    expect(element).to.have.attribute('color-palette', 'lighter');
  });
