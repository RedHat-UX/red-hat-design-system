...
export class RhFooterUniversal extends LitElement {
  ...
  colorPalette: ColorPalette = 'darker';
  ...
  override render() {
    ...
    return html`
      <footer role="${ifDefined(footer ? 'none' : undefined)}">
        ...
        <!-- base -->
        <div
          class="section global-base ${classMap({ hasTertiary })}"
          part="section base"
        >
          <slot name="base">
            <!-- logo -->
            ...
            <div class="global-primary" part="primary">
              ...
              <slot name="primary">
                <!-- primary-start -->
                <div
                  class="global-primary-start"
                  part="primary-start"
                  ?hidden=${!this.#slots.hasSlotted('primary-start')}
                >
                  <!-- primary-start -->
                ...
                <!-- links-primary -->
                <div
                  class="global-links-primary"
                  part="links-primary"
                  ?hidden=${!this.#slots.hasSlotted('links-primary')}
                >
                  <!-- links-primary -->
                ...
                <!-- primary-end -->
                <div
                  class="global-primary-end"
                  part="primary-end"
                  ?hidden=${!this.#slots.hasSlotted('primary-end')}
                >
                  <!-- primary-end -->
            ...
            <div class="global-secondary" part="secondary">
              ...
              <slot name="secondary">
                <!-- secondary-start -->
                <div
                  class="global-secondary-start"
                  part="secondary-start"
                  ?hidden=${!this.#slots.hasSlotted('secondary-start')}
                >
                  <!-- secondary-start -->
                ...
                <!-- links-secondary -->
                <div
                  class="global-links-secondary"
                  part="links-secondary"
                  ?hidden=${!this.#slots.hasSlotted('links-secondary')}
                >
                  <!-- links-secondary -->
                ...
                <!-- secondary-end -->
                <div
                  class="global-secondary-end"
                  part="secondary-end"
                  ?hidden=${!this.#slots.hasSlotted('secondary-end')}
                >
                  <!-- secondary-end -->
            ...
            <!-- tertiary -->
            <div
              class="global-tertiary"
              part="tertiary"
              ?hidden=${!this.#slots.hasSlotted('tertiary')}
            >
              <!-- tertiary -->
