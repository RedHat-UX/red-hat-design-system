...
<rh-audio-player lang="en-US"
  ...
  <rh-audio-player-subscribe slot="subscribe">
    <a slot="link"
      ...
      <img src="https://www.redhat.com/cms/managed-files/badge_apple-podcast-white.svg"
    ...
    <a slot="link"
      ...
      <img src="https://www.redhat.com/cms/managed-files/badge_spotify.svg"
    ...
    <a slot="link"
      ...
      <img src="https://www.redhat.com/cms/managed-files/badge_google-podcast.svg"
  ...
  <rh-audio-player-transcript slot="transcript">
    <rh-audio-player-cue start="00:02"
                         voice="Burr Sutter"></rh-audio-player-cue>
    <rh-audio-player-cue start="00:02"
                         end="00:04">
      Hi, I'm Burr Sutter.
    </rh-audio-player-cue>
    ...
    <rh-audio-player-cue start="00:05"
                         end="00:08">
    ...
    <rh-audio-player-cue start="00:10"
                         end="00:14">
    ...
    <rh-audio-player-cue start="00:17"
                         end="00:18">
    ...
    <rh-audio-player-cue start="00:19"
                         end="00:22">
    ...
    <rh-audio-player-cue start="00:51"
                         end="00:53">
      runtime environment.
    </rh-audio-player-cue>
    ...
    <rh-audio-player-cue start="01:21"
                         end="01:24">
    ...
    <rh-audio-player-cue start="01:27"
                         end="01:30">
    ...
    <rh-audio-player-cue start="01:45"
                         end="01:49">
    ...
    <rh-audio-player-cue start="02:07"
                         end="02:10">
      don't you need a GPU for a I inferencing a GPU
    </rh-audio-player-cue>
    <rh-audio-player-cue start="02:10"
                         end="02:12">
      for artificial intelligence machine learning?
    </rh-audio-player-cue>
    <rh-audio-player-cue start="02:12"
                         end="02:15">
      Well, not according to Ryan Loney, product manager of Open Vino Developer
    </rh-audio-player-cue>
    <rh-audio-player-cue start="02:15"
                         end="02:16">
      Tools at Intel.
    </rh-audio-player-cue>
    <rh-audio-player-cue start="02:20"
                         voice="Ryan Loney"></rh-audio-player-cue>
    <rh-audio-player-cue start="02:20"
                         end="02:20">
      I guess we'll
    </rh-audio-player-cue>
