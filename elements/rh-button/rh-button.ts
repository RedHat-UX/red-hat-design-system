...
/**
 * A button communicates and triggers available actions when clicked or selected. Buttons allow users to perform an action when triggered. They feature a text label, a background or a border, and icons.
 *
