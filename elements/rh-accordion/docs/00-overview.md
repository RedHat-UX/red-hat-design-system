...
<rh-accordion>
  ...
  <h2><rh-accordion-header>Consectetur id nisi do ipsum anim labore mollit cillum fugiat elit</rh-accordion-header></h2>
  <rh-accordion-panel>
  ...
  <h2><rh-accordion-header>Culpa dolore aute ipsum ut quis nulla Lorem sit deserunt</rh-accordion-header></h2>
  <rh-accordion-panel>
  ...
  <h2><rh-accordion-header>Ipsum exercitation eu esse incididunt nisi anim quis non ex anim pariatur labore deserunt</rh-accordion-header></h2>
  <rh-accordion-panel>
  ...
  <h2><rh-accordion-header>Duis nisi ex irure dolore nulla et tempor adipisicing tempor commodo</rh-accordion-header></h2>
  <rh-accordion-panel>
