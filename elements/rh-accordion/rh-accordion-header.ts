...
import style from './rh-accordion-header.css';
 ...
 * @fires {CustomEvent<{ expanded: Boolean; toggle: RhAccordionHeader }>} rh-accordion:change -
 ...
 *        ```
 */
@customElement('rh-accordion-header') @pfelement()
export class RhAccordionHeader extends LitElement {
  ...
  override connectedCallback() {
    ...
    this.hidden = true;
    this.id ||= getRandomId('rh-accordion');
  }
