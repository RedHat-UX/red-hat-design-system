import type { RhNavigationPrimaryHamburger } from './rh-navigation-primary-hamburger.js';
...
export class RhNavigationPrimary extends LitElement {
  ...
  @query('#hamburger')
  private _hamburger!: RhNavigationPrimaryHamburger;
    ...
    return html`
      <div id="container" class="${classMap({ compact: this.compact, rtl })}">
        <div id="bar">
          ...
          <rh-navigation-primary-hamburger id="hamburger"
                                           @toggle="${this.#onToggle}">
            <slot name="summary" slot="summary">Menu</slot>
            <slot></slot>
