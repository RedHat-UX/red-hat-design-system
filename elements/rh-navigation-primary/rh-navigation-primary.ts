          ...
          <div id="lockup">
            <div id="logo">
              <a href="${this.logoHref}">
                <!--
                  Accepts an inline SVG or \`<img>\` to override the default
                  Red Hat logo.  Slotted images should be swapped on scheme
                  change or support light-dark() such as in an inline SVG.
                -->
                <slot name="logo">
