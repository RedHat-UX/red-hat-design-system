        ...
        <div id="bar">
          ...
          <details id="hamburger" ?open="${this._hamburgerOpen}" @toggle="${this.#hamburgerToggle}" @focusout="${this.#onHamburgerFocusOut}">
            ...
            <div id="details-content" role="list" >
              <!-- 
                Use this slot for \`<rh-primary-navigation-item>\` hamburger menu links and dropdowns. If left 
                empty will result in accessibility issues. 
              -->
              <slot></slot>
            </div>
          ...
          <div id="secondary">
            ...
            <!--
              ...
              the \`<rh-navigation-primary-item slot="links">\` element. If any 
              other element is slotted here, it will need to be a role="listitem" to avoid accessibility 
              issues.  Other slottedelements will also likely have other rendering issues.
            -->
