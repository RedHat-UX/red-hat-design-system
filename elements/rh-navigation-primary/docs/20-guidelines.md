...
<uxdot-example width-adjustment="1000px" variant="full" alignment="left" no-border>
  <img src="{{ '../primary-nav-usage-intro.png' | url }}" alt="Primary navigation - usage">
</uxdot-example>
...
<uxdot-example width-adjustment="1000px" variant="full" alignment="left" no-border>
  <img src="{{ '../full-width-tray-3-columns.png' | url }}" alt="Primary navigation - full-width expandable tray (three columns)">
</uxdot-example>

<uxdot-example width-adjustment="1000px" variant="full" alignment="left" no-border>
  <img src="{{ '../full-width-tray-2-columns.png' | url }}" alt="Primary navigation - full-width expandable tray (two columns)">
</uxdot-example>
...
<uxdot-example width-adjustment="1000px" variant="full" alignment="left" no-border>
  <img src="{{ '../fixed-width-tray.png' | url }}" alt="Primary navigation - fixed-width expandable tray">
</uxdot-example>
...
<uxdot-example width-adjustment="1000px" variant="full" alignment="left" no-border>
  <img src="{{ '../menu-slots.png' | url }}" alt="Primary navigation - menu slots">
</uxdot-example>
...
<uxdot-example width-adjustment="1000px" variant="full" alignment="left" no-border>
  <img src="{{ '../components-in-tray-desktop.png' | url }}" alt="Primary navigation - components in an expandable tray (desktop)">
</uxdot-example>

<uxdot-example width-adjustment="360px" variant="full" alignment="left" no-border>
  <img src="{{ '../components-in-tray-mobile.png' | url }}" alt="Primary navigation - components in an expandable tray (mobile)">
</uxdot-example>
...
<uxdot-example width-adjustment="1000px" variant="full" alignment="left" no-border>
  <img src="{{ '../primary-nav-utilities.png' | url }}" alt="Primary navigation - utilities">
</uxdot-example>
...
<uxdot-example width-adjustment="1000px" variant="full" alignment="left" no-border>
  <img src="{{ '../utility-ordering.png' | url }}" alt="Primary navigation - utility ordering">
</uxdot-example>
...
<uxdot-example width-adjustment="1000px" variant="full" alignment="left" no-border>
  <img src="{{ '../menus-utilities-small-breakpoints.png' | url }}" alt="Primary navigation - menus and utilities on small breakpoints">
</uxdot-example>
...
<uxdot-example width-adjustment="1000px" variant="full" alignment="left" no-border>
  <img src="{{ '../example-rhdc.png' | url }}" alt="Primary navigation - redhat.com example">
</uxdot-example>
...
<uxdot-example width-adjustment="1000px" variant="full" alignment="left" no-border>
  <img src="{{ '../example-developer.png' | url }}" alt="Primary navigation - Developer example">
</uxdot-example>
...
<uxdot-example width-adjustment="1000px" variant="full" alignment="left" no-border>
  <img src="{{ '../example-hybrid-cloud.png' | url }}" alt="Primary navigation - Hybrid Cloud example">
</uxdot-example>
...
<uxdot-example width-adjustment="1000px" variant="full" alignment="left" no-border>
  <img src="{{ '../primary-nav-menus.png' | url }}" alt="Primary navigation - menus">
</uxdot-example>
...
<uxdot-example width-adjustment="1000px" variant="full" alignment="left" no-border>
  <img src="{{ '../utility-menus-vs-links.png' | url }}" alt="Primary navigation - utility menus vs. links">
</uxdot-example>
...
<uxdot-example width-adjustment="1000px" variant="full" alignment="left" no-border>
  <img src="{{ '../primary-nav-stacking.png' | url }}" alt="Primary navigation - stacking">
</uxdot-example>
...
<uxdot-example width-adjustment="1000px" variant="full" alignment="left" no-border>
  <img src="{{ '../scrolling-with-tray-1.png' | url }}" alt="Primary navigation - scrolling with expandable tray">
</uxdot-example>
...
<uxdot-example width-adjustment="1000px" variant="full" alignment="left" no-border>
  <img src="{{ '../scrolling-with-tray-2.png' | url }}" alt="Primary navigation - scrolling with expandable tray">
</uxdot-example>
...
<uxdot-example width-adjustment="1000px" variant="full" alignment="left" no-border>
  <img src="{{ '../navigating-between-trays.png' | url }}" alt="Primary navigation - navigating between expandable trays">
</uxdot-example>
...
<uxdot-example width-adjustment="1000px" variant="full" alignment="left" no-border>
  <img src="{{ '../collapsing-expandable-tray.png' | url }}" alt="Primary navigation - collapsing the expandable tray">
</uxdot-example>
...
<uxdot-example width-adjustment="1000px" variant="full" alignment="left" no-border>
  <img src="{{ '../interaction-state-default.png' | url }}" alt="Primary navigation - default interaction state">
</uxdot-example>
...
<uxdot-example width-adjustment="1000px" variant="full" alignment="left" no-border>
  <img src="{{ '../interaction-state-hover.png' | url }}" alt="Primary navigation - hover interaction state">
</uxdot-example>
...
<uxdot-example width-adjustment="1000px" variant="full" alignment="left" no-border>
  <img src="{{ '../interaction-state-focus.png' | url }}" alt="Primary navigation - focus interaction state">
</uxdot-example>
...
<uxdot-example width-adjustment="1000px" variant="full" alignment="left" no-border>
  <img src="{{ '../interaction-state-active.png' | url }}" alt="Primary navigation - active interaction state">
</uxdot-example>
...
<uxdot-example width-adjustment="1000px" variant="full" alignment="left" no-border>
  <img src="{{ '../focus-order.png' | url }}" alt="Primary navigation - focus order">
</uxdot-example>
